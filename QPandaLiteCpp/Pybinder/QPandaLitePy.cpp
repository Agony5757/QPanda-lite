...
PYBIND11_MODULE(QPandaLitePy, m)
{
	...
	py::class_<qpandalite::Simulator>(m, "Simulator")
		...
		.def("cnot_cont", &qpandalite::Simulator::cnot_cont, py::arg("controller"), py::arg("target"), py::arg("control"), py::arg("dagger") = false)
	...
	py::enum_<qpandalite::SupportOperationType>(m, "SupportOperationType")
        ...
        .value("IDENTITY", qpandalite::SupportOperationType::HADAMARD)
	...
	py::class_<qpandalite::NoisySimulator>(m, "NoisySimulator")
		...
		// .def("u22", &qpandalite::NoisySimulator::u22, py::arg("is_dagger") = false)
		...
		.def("swap", &qpandalite::NoisySimulator::swap, py::arg("qn1"), py::arg("qn2"), py::arg("is_dagger") = false)
		...
		.def("toffoli", &qpandalite::NoisySimulator::toffoli, py::arg("qn1"), py::arg("qn2"), py::arg("target"), py::arg("dagger") = false)
		.def("cswap", &qpandalite::NoisySimulator::cswap, py::arg("controller"), py::arg("target1"), py::arg("target2"), py::arg("dagger") = false)
        ...
        .def("cnot_cont", &qpandalite::NoisySimulator::cnot_cont, py::arg("controller"), py::arg("target"), py::arg("control"), py::arg("dagger") = false)        
