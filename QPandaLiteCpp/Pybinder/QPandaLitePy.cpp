...
PYBIND11_MODULE(QPandaLitePy, m)
{
	...
	py::class_<qpandalite::Simulator>(m, "Simulator")
		...
		.def("swap", &qpandalite::Simulator::swap, py::arg("qn1"), py::arg("qn2"), py_arg_global_controller, py_arg_dagger)
		...
		.def("u2", &qpandalite::Simulator::u2, py::arg("qn"), py::arg("phi"), py::arg("lambda"), py_arg_global_controller, py_arg_dagger)
	...
	py::class_<qpandalite::DensityOperatorSimulator>(m, "DensityOperatorSimulator")
		...
		.def("u2", &qpandalite::DensityOperatorSimulator::u2, py::arg("qn"), py::arg("phi"), py::arg("lambda"), py_arg_global_controller, py_arg_dagger)
