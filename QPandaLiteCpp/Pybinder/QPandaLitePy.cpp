...
PYBIND11_MODULE(QPandaLitePy, m)
{
	...
	py::class_<qpandalite::NoisySimulator>(m, "NoisySimulator")
		...
		.def("id", &qpandalite::NoisySimulator::id, py::arg("qn"), py::arg("is_dagger") = false)		.def("get_measure_no_readout_error", &qpandalite::NoisySimulator::get_measure_no_readout_error)
